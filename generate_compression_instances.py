...
if n == 4:
	...
	factors = [2, 3, 6, 9, 18, 27]
elif n == 55:
	factors = [5, 11]
elif n == 56:
	factors = [2, 4, 7, 8, 14, 28]
elif n == 57:
	factors = [3, 19]
elif n == 58:
	factors = [2, 29]
	...
	factors = [n]
#	print "no support for performing compression on that order"
#	quit()

# Compression with too many even factors leads to an explosion of cases
#if n % 2 == 0:
#	factors = factors[-1:]
		...
		for case2 in range(case2len):
			for case3 in range(case3len):
				for case4 in range(case4len):
					...
					count += 1
					f = open(assumname % runstr(n,c,count), "w")
					for cl in clauses2:
						f.write(cl+"\n")
