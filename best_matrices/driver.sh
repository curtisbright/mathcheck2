if [ -z "$1" ]
then
	echo "Use ./driver.sh n to enumerate best matrices of odd orders n divisible by 3"
	echo "or ./driver.sh n m to enumerate best matrices of odd orders between n and m divisible by 3"
	exit
else
	if [ -z "$2" ]
	then
