...
{	
	...
	{	int k = coprimelist[n][j];
		...
		std::array<int, MAX_N> altpermutedA = permuteA(l, l-1, permutedA);
		std::array<int, MAX_N> altpermutedB = permuteA(l, l-1, permutedB);
		std::array<int, MAX_N> altpermutedC = permuteA(l, l-1, permutedC);
